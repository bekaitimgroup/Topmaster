...
const MAKES = [
  ...
  { name: 'Chevrolet (UzAuto)', isLocal: true, sortOrder: 1, models: [
  ...
  { name: 'Ravon', isLocal: true, sortOrder: 2, models: [
  ...
  // ── Chinese brands ───────────────────────────────────────────────────────────
  { name: 'BYD', isLocal: false, sortOrder: 10, models: [
  ...
  { name: 'Chery', isLocal: false, sortOrder: 11, models: [
  ...
  { name: 'Geely', isLocal: false, sortOrder: 12, models: [
  ...
  { name: 'Haval', isLocal: false, sortOrder: 13, models: [
  ...
  { name: 'JAC', isLocal: false, sortOrder: 14, models: [
  ...
  { name: 'Lifan', isLocal: false, sortOrder: 15, models: [
  ...
  { name: 'Changan', isLocal: false, sortOrder: 16, models: [
  ...
  { name: 'Omoda', isLocal: false, sortOrder: 17, models: [
    { name: 'C5', yearFrom: 2021, sortOrder: 1 },
    { name: 'C9', yearFrom: 2022, sortOrder: 2 },
  ]},
  { name: 'Jetour', isLocal: false, sortOrder: 18, models: [
  ...
  { name: 'BAIC', isLocal: false, sortOrder: 19, models: [
  ...
  { name: 'Dongfeng (DFM)', isLocal: false, sortOrder: 20, models: [
  ...
  { name: 'Great Wall', isLocal: false, sortOrder: 21, models: [
  ...
  // ── Korean brands ────────────────────────────────────────────────────────────
  { name: 'Hyundai', isLocal: false, sortOrder: 30, models: [
  ...
  { name: 'Kia', isLocal: false, sortOrder: 31, models: [
  ...
  { name: 'Daewoo', isLocal: false, sortOrder: 32, models: [
  ...
  // ── Japanese brands ──────────────────────────────────────────────────────────
  { name: 'Toyota', isLocal: false, sortOrder: 40, models: [
  ...
  { name: 'Lexus', isLocal: false, sortOrder: 41, models: [
  ...
  { name: 'Nissan', isLocal: false, sortOrder: 42, models: [
  ...
  { name: 'Honda', isLocal: false, sortOrder: 43, models: [
  ...
  { name: 'Mitsubishi', isLocal: false, sortOrder: 44, models: [
  ...
  { name: 'Subaru', isLocal: false, sortOrder: 45, models: [
  ...
  { name: 'Mazda', isLocal: false, sortOrder: 46, models: [
  ...
  { name: 'Infiniti', isLocal: false, sortOrder: 47, models: [
  ...
  // ── European brands ──────────────────────────────────────────────────────────
  { name: 'Volkswagen', isLocal: false, sortOrder: 50, models: [
  ...
  { name: 'Mercedes-Benz', isLocal: false, sortOrder: 51, models: [
  ...
  { name: 'BMW', isLocal: false, sortOrder: 52, models: [
  ...
  { name: 'Audi', isLocal: false, sortOrder: 53, models: [
  ...
  { name: 'Porsche', isLocal: false, sortOrder: 54, models: [
  ...
  { name: 'Land Rover', isLocal: false, sortOrder: 55, models: [
  ...
  { name: 'Opel / Vauxhall', isLocal: false, sortOrder: 56, models: [
  ...
  // ── American brands ──────────────────────────────────────────────────────────
  { name: 'Ford', isLocal: false, sortOrder: 60, models: [
  ...
  { name: 'Jeep', isLocal: false, sortOrder: 61, models: [
  ...
  // ── Russian brands ───────────────────────────────────────────────────────────
  { name: 'LADA (ВАЗ)', isLocal: false, sortOrder: 70, models: [
  ...
  { name: 'UAZ', isLocal: false, sortOrder: 71, models: [
  ...
  // ── Other ────────────────────────────────────────────────────────────────────
  { name: 'Boshqa marka / Другая марка', isLocal: false, sortOrder: 99, models: [
...
async function main() {
  ...
  for (const make of MAKES) {
    const created = await prisma.carMake.create({
      data: { name: make.name, isLocal: make.isLocal, sortOrder: make.sortOrder },
    });
    ...
    console.log(`  ${make.isLocal ? '[UZ]' : '   '} ${make.name} (${make.models.length} models)`);
